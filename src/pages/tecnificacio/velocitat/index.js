...
const schedule = [
  { period: "Dilluns", schedule: "18:00 a 20:30" },
  { period: "Dimarts", schedule: "18:00 a 20:30" },
  { period: "Dijous", schedule: "18:00 a 20:30" },
  { period: "Divendres", schedule: "18:00 a 20:30" },
];
...
export default function Tecnificacio({ preview, allPosts }) {
  ...
  return (
    <div className="bg-white">
              ...
              <div className="flex justify-start lg:w-0 lg:flex-1">
                <a href="#">
                  ...
                  <img
                    ...
                    src="https://tailwindui.com/img/logos/workflow-mark.svg?from-color=orange&from-shade=400&to-color=pink&to-shade=500&toShade=500"
                    alt=""
                  />
                </a>
              </div>
        ...
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:max-w-7xl">
          <div className="px-0 sm:px-4 lg:px-0 lg:flex lg:justify-between lg:items-center">
            <div className="max-w-xl">
              <h2 className="text-4xl tracking-tight font-bold text-white sm:text-5xl sm:tracking-tight lg:text-6xl lg:tracking-tight">
                {allPosts.name}
              </h2>
      ...
      <div className="bg-white">
        <h2 className="text-center text-3xl py-8 leading-8 font-bold tracking-tight text-gray-900 sm:text-4xl sm:tracking-tight">
          Informació
        </h2>
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:py-16 lg:px-8 lg:grid lg:grid-cols-4 lg:gap-x-8">
          <div className="divide-y-2 divide-gray-100">
            <p className="text-center mt-2 text-2xl tracking-tight font-bold text-gray-900">
              Horaris
            </p>
              ...
              <dl>
                {schedule.map((sch, idx) => (
                  <div
                    ...
                    className={
                      idx % 2 == 0
                        ? "bg-white py-1 sm:py-2 sm:grid sm:grid-cols-3 sm:gap-4"
                        : "bg-white py-1 sm:py-2 sm:grid sm:grid-cols-3 sm:gap-4"
                    }
                  >
                    <dt className="text-md text-width-600 font-medium text-gray-500">
                      <strong>{sch.period}</strong>
                    </dt>
          ...
          <div className="divide-y-2 divide-gray-100">
            ...
            <ul role="list" className="mt-4 text-md text-gray-500">
              {allPosts.categories.items.map((category) => (
                <li key={category.name} className="px-6 py-1">
                  <UsersIcon
                    className="absolute h-6 w-6 text-black-500"
                    aria-hidden="true"
                  />
                  <p className="relative ml-9 text-md leading-6 font-medium text-gray-900">
                    {category.name}
                  </p>
                </li>
              ))}
          ...
          {allPosts.groups.items.map((group) => (
            <div key={group.name} className="divide-y-2 divide-gray-100">
              <p className="text-center mt-2 text-2xl tracking-tight font-bold text-gray-900">
                {group.name}
              </p>
              <ul role="list" className="mt-4 text-md text-gray-500">
                {group.events.items.map((event) => (
                  <li key={event.name} className="px-6 py-1">
                    <UsersIcon
                      className="absolute h-6 w-6 text-black-500"
                      aria-hidden="true"
                    />
                    <p className="relative ml-9 text-lg leading-6 font-medium text-gray-900">
                      {event.name}
                    </p>
                  </li>
                ))}
      ...
      <div className="divide-y-2 divide-gray-100"></div>
      {/* Coaches */}
      <div className="bg-white">
        <h2 className="text-center text-3xl py-8 leading-8 font-bold tracking-tight text-gray-900 sm:text-4xl sm:tracking-tight">
        ...
        <div className="mx-auto py-6 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-8">
          <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
            <div className="space-y-5 sm:space-y-4 text-xl text-gray-500">
              <div className={markdownStyles["markdown"]}>
                {documentToReactComponents(
                  allPosts.schedule.json,
                  customMarkdownOptions(allPosts.schedule)
                )}
              </div>
            </div>
            <div className="lg:col-span-2">
              ...
              >
                {allPosts.coaches.items.map((person) => (
                  <li key={person.name} className="sm:py-8">
                    <div className="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0">
                      <div className="aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4">
                        <img
                          className="object-cover shadow-lg rounded-lg h-48 w-48"
                      ...
                      <div className="sm:col-span-2">
                        <div className="space-y-4">
                          ...
                          <div className="text-lg">
                            <p className="text-gray-500">{person.quote}</p>
                          </div>
...
export async function getStaticProps({ preview = false }) {
  const allPosts = (await getGroupWithId("grupo-e")) ?? [];
  return {
